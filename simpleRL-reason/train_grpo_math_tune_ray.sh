...
export WANDB_API_KEY=""  # Leave empty for local logging only
export WANDB_OFFICIAL=1
export VLLM_ATTENTION_BACKEND=XFORMERS
export HDFS_DATA_PATH="/home/ec2-user/dataset/simpleRL-reason"
export HDFS_MODEL_PATH="/home/ec2-user/models"
export HDFS_CHECKPOINT_PATH="/home/ec2-user/checkpoints"
export HDFS_LOG_PATH="/home/ec2-user/logs"
...
export WORKING_DIR="/home/ec2-user/dataset/simpleRL-reason"
